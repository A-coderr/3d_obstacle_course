        ...
        <div className="absolute inset-0 flex flex-row items-center justify-center z-50 bg-gradient-to-t from-[#3d006e] via-[#231e52] to-[#19153b]">
          ...
          <div className="w-1/2 h-screen flex items-center justify-center">
            <div className="bg-[#000025] text-white py-10 px-2 border-2 border-pink-500 rounded-lg shadow-[0_0_15px_#ff00ff] flex flex-col items-center max-w-2xl w-full select-none">
              ...
              <div className="flex flex-row items-center gap-20 mt-20">
              ...
              <button
                className="mt-20 px-10 py-4 text-white font-bold uppercase bg-black border-2 border-purple-500 rounded-lg shadow-[0_0_15px_#a855f7] hover:shadow-[0_0_25px_#a855f7] transition duration-300"
                onClick={() => {
                  dispatch(startGame());
